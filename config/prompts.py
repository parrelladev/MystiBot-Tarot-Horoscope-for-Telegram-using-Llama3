...
HOROSCOPE_PROMPT = """Você é um astrólogo experiente. Forneça um horóscopo diário para o signo de {user_sign}.
...
Palpite do dia: 05, 41, 04

Cor para o dia: AZUL-ESVERDEADO""" 